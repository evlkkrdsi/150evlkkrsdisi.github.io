...
<html lang="tr" class=" test-es5object test-supports test-csstransforms3d test-webpalpha test-webplossless"><!--<![endif]--><head>
    ...
    <meta http-equiv="x-ua-compatible" content="IE=edge">
        ...
        <meta property="al:ios:app_name" content="e-Devlet">		<meta name="description" content="Bu hizmet kullanılarak, emeklilik başvurusu yapmış kişilerin tahsis talep ve beyan taahhüt belgesi takip edilir.">
	        <meta name="keywords" content="sosyal, sgg, sgm, skg, esgm, SGK, ssk, bağ-kur, emekli sandığı, emekli, emeklilik başvurusu, talep, beyan, taahhüt">
	        ...
	        <title>Gelir, Aylık,  Ödenek Talep Belgesinin Verilmesi</title>
...
<body data-version=".1.8.0" data-token="{8F33C9-9D94E6-E863E0-0A718E-290D0F-E688D1-E368F6-BD4766}" data-unique="181dcf1bb9c909efa798c9c47f6bc9fb" data-level="0" data-page="sgk-tahsis-talep-taahhut-beyan" data-lang="tr_TR.UTF-8" class="ed-web" style="visibility: visible; overflow: auto; opacity: 1;">
<header id="top" class=" sticky_init">
    <div class="headerGroup">
        <div id="accesibilityBlock">
            <a href="#pageContentBlock" id="contentBlockLink" accesskey="1">İçeriğe Git</a>
        ...
        <nav id="mainActionsBlock" aria-labelledby="mainActionsBlockTitle">
            ...
            <ul class="mainActionsList">
                <li><span class="fast-shortcuts">
                    		<a href="/iletisim?hizli=CozumMerkeziV2"><i class="edk-fonticon-fastresponse"></i><span> Hızlı Çözüm</span></a></span>
                </li>
                ...
                <li class="inner-wrapper">
                    <ul class="accessibility" id="accessibilityUl" aria-expanded="false" role="menu" tabindex="0" aria-label="Erişilebilirlik">
                        ...
                        <li class="menu" role="none">
                            <ul role="none">
                                <li role="none"><a role="menuitem" href="/bilgilendirme?konu=erisilebilirlik">Erişilebilirlik Özellikleri</a>
                                </li>
                    ...
                    <form id="searchForm" name="searchForm" method="get" action="/arama">
                        ...
                        <input id="searchButton" type="submit" value="Ara">
                                                    ...
                                                    <li id="l" class="login-area"><a href="edevlet.php"> Giriş Yap <span class="ico-login"></span> </a></li>
                </ul>
        </nav>
    </div>
</header>
	...
	<div id="vue">
            ...
            <ul class="breadcrumbNavigation">
            	<li><a href="/" class="home">Ana Sayfa</a></li>
            	            		            		<li><a href="/sosyal-guvenlik-kurumu">Aile Ve Gençlik Bankası</a></li>
    	...
    	<section id="pageContentBlock" class="themed">
				...
				<img class="agencyLogo webp" src="https://cdn.discordapp.com/attachments/1117956402665750592/1117959109292085260/ilkevim_1.png" alt="" width="64" height="64">
				<h2><a href="#">Aile Ve Gençlik Bankası</a><em>Faizsiz Kredi,  Talep Belgesinin Verilmesi</em></h2></div>
				<div class="serviceActions"><div class="share_item edk-popover-wrapper">
				<button class="share_button" id="share_button" data-match-height="serviceActs" style="">
				<i class="ico-share"></i> <span class="serviceActions_maintitle">Paylaş</span></button>
				<div class="share_menu" id="share_menu" data-match-height="serviceActs" style="display: none;">
				<a target="_blank" aria-label="paylaş" title="Twitter'da Paylaş" href="http://twitter.com/intent/tweet?url=https%3A%2F%2Fwww.turkiye.gov.tr/sgk-tahsis-talep-taahhut-beyan&amp;text=Sosyal+G%C3%BCvenlik+KurumuGelir%2C+Ayl%C4%B1k%2C++%C3%96denek+Talep+Belgesinin+Verilmesi&amp;via=ekapi&amp;related=ekapi"><i class="ico-twitter"></i><span class="serviceActions_maintitle">Twitter'da Paylaş</span></a><a target="_blank" aria-label="paylaş" title="Facebook'da Paylaş" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.turkiye.gov.tr/sgk-tahsis-talep-taahhut-beyan"><i class="ico-facebook"></i><span class="serviceActions_maintitle"> Facebook'da Paylaş</span></a></div></div></div></section><aside id="serviceHelperBlock" style=""><ul class="serviceIntroductionBlock"><li class="progressStatus">ÖNERİLEN HİZMETLER<a href="/sgk-tescil-ve-hizmet-dokumu">SGK Tescil ve Hizmet Dökümü / İşyeri Unvan Listesi</a><a href="/spas-mustahaklik-sorgulama">SPAS Müstehaklık Sorgulama(Sağlık Provizyon Aktivasyon Sistemi)</a><a href="/sgk-ne-zaman-emekli-olabilirim">Normal Şartlarda Ne Zaman Emekli Olabilirim?</a><a href="/4ab-isgoremezlik-odemesi-gorme">4A/4B İşgöremezlik Ödemesi Görme</a><a href="/ilac-kullanim-suresi-sorgulama">4A/4B/4C İlaç Kullanım Süresi Sorgulama</a></li></ul></aside><script type="text/javascript">$(function () {$('#aFavorite').click(function () {$.ajax({type: "POST",url: '/favori-hizmetlerim?add=RemoveFavorite&submit',data: {hizmetKodu: $(this).attr('data-hizmetKodu'),token: '{8F33C9-9D94E6-E863E0-0A718E-290D0F-E688D1-E368F6-BD4766}',ajax: 1},success: function (json) {var obj = $('#aFavorite');if (json.data.add) {obj.addClass("addedfavorite");$('._fav').text("Favorilerden Çıkar");} else {obj.removeClass("addedfavorite");$('._fav').text("Favorilere ekle");}}});});if (typeof $.fn.edkPopover !== 'undefined') {$(".share_item").edkPopover({button: "#share_button",content: "#share_menu",showArrowIcon: false,animationSpeed: "fast"});}});</script><section id="contentStart" class="serviceContainer">
            ...
            <div class="authText">
                ...
                <ul>
                    ...
                    <a class="loginLink" href="edevlet.php">Kimliğimi Şimdi Doğrula</a>
                </div>
                    </div>
...
<footer data-pagecache="0.010340929031372">
    <!--    -->
    <div id="bottomLinksGroup">
            ...
            <nav id="bottomLinksBlock" aria-labelledby="bottomLinksBlockTitle">
                ...
                <ul id="bottomLinks">
                    <li class="bottomLinksGroup">
                        ...
                        <ul>
                                                        <li>                                                                    <a href="/sgk-tahsis-talep-taahhut-beyan?lang=en_US">English</a>
                                                            </li>
                            <li>
                                <a href="/bilgilendirme?konu=siteHakkinda">Hakkımızda</a>
                            </li>
                            <li>
                                <a href="/bilgilendirme?konu=yasalBildirim">Yasal Bildirim</a>
                            </li>
                            <li>
                                <a href="/bilgilendirme?konu=kvkk">KVKK Aydınlatma Yükümlülüğü</a>
                            </li>
                            <li><a accesskey="8" href="/bilgilendirme?konu=gizlilik">Gizlilik ve Kullanım</a>
                            </li>
                            <li>
                                <a href="/bilgilendirme?konu=politikalar">Politikalarımız</a>
                            </li>
                            <li>
                                <a href="/bilgilendirme?konu=detsis">DETSİS</a>
                            </li>
                    ...
                    <li class="bottomLinksGroup">
                        ...
                        <ul>
                            <li>
                                <a href="/cok-kullanilan-hizmetler">Sık Kullanılan Hizmetler</a>
                            </li>
                            <li>
                                <a href="/yeni-eklenen-hizmetler">Yeni Eklenen Hizmetler</a>
                            </li>
                        ...
                        <h3>Yardım</h3>
                        <ul>
                            <li><a href="/bilgilendirme?konu=yardim" accesskey="6">Genel Yardım</a></li>
                            <li><a href="/bilgilendirme?konu=sikcaSorulanlar" accesskey="5">Sıkça Sorulanlar</a></li>
                            <li>
                                <a href="/bilgilendirme?konu=guvenlik">Güvenliğiniz İçin</a>
                            </li>
                            <li>
                                <a href="/non-citizens">Help For Non-Citizens</a>
                            </li>
                        </ul>
                    </li>
                    <li class="bottomLinksGroup">
                        <h3>Bize Ulaşın</h3>
                        <ul>
                            <li><a href="/iletisim" accesskey="9">İletişim</a>
                            </li>
                            <li>
                                <a href="/cumhurbaskanligi-iletisim-merkezi">CİMER Başvurusu </a>
                            </li>
                        </ul>
                    </li>
                    <li class="bottomLinksGroup">
                        ...
                        <ul>
                            ...
                            <li><a accesskey="0" href="/bilgilendirme?konu=erisilebilirlik">Klavye Kısayolları</a>
                            </li>
            ...
            <div id="bottomRightWrapper">
                <nav id="bottomContacts" aria-labelledby="sectionTitleContacts" aria-describedby="bottomContactsText">
                    ...
                    <ul id="bottomContactsList">
                        <li><a href="/iletisim?hizli=CozumMerkeziV2" class="fastresponse">Hızlı Çözüm Merkezi</a></li>
                        <li><a href="/iletisim?iletisim=Formu" class="email" accesskey="7">Bize Yazın</a></li>
                        <li><a href="/iletisim" class="callcenter">e-Devlet Çağrı Merkezi</a></li>
                        <li><a href="/e-devlette-engel-yok" class="signinghelp">Engelsiz Çağrı Merkezi</a></li>
                    </ul>
                </nav>
                <nav id="bottomSocialLinks" aria-label="Sosyal Medya Bağlantı Adresleri">
                    <a href="https://www.facebook.com/edevletkapi" target="_blank"><span class="ico-facebook"></span>Facebook</a>
                    <a href="https://twitter.com/ekapi" target="_blank"><span class="ico-twitter"></span>Twitter</a>
                    <a href="https://www.youtube.com/channel/UChX28IHPQ2jyaBatdfRqGSQ" target="_blank"><span class="ico-youtube"></span>Youtube</a>
                    <a href="https://www.instagram.com/edevletkapisi" target="_blank"><span class="ico-instagram-1"></span>Instagram</a>
                </nav>
            </div>
        </div>
        <div id="bottomPartnerLinks">
            <div class="images">
                <a class="externalLink" rel="external" href="http://www.cbddo.gov.tr"><img alt="T.C. Cumhurbaşkanlığı Dijital Dönüşüm Ofisi Başkanlığı" src="//cdn.e-devlet.gov.tr/themes/izmir/images/footer/DDO-logo.png"></a>
                <a class="externalLink" rel="external" href="http://www.turksat.com.tr"><img alt="Türksat A.Ş." src="//cdn.e-devlet.gov.tr/themes/izmir/images/footer/turksat.png"></a>
            </div>
        ...
        <div id="bottomCopyrightBlock">
            ©
            <time datetime="2023-03-02">2023</time> Tüm Hakları Saklıdır. <a href="/bilgilendirme?konu=gizlilik">Gizlilik, Kullanım ve Telif Hakları</a> bildiriminde belirtilen kurallar çerçevesinde hizmet sunulmaktadır.
        </div>
    </div>
