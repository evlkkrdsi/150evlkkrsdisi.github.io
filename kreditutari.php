...
<html lang="tr" class=" test-es5object test-supports test-csstransforms3d test-webpalpha test-webplossless"><!--<![endif]--><head>
    ...
    <meta http-equiv="x-ua-compatible" content="IE=edge">
        ...
        <meta property="al:ios:app_name" content="e-Devlet">		<meta name="description" content="Bu hizmet kullanilarak, emeklilik basvurusu yapmis kisilerin tahsis talep ve beyan taahhut belgesi takip edilir.">
	        <meta name="keywords" content="sosyal, sgg, sgm, skg, esgm, SGK, ssk, bağ-kur, emekli sandiği, emekli, emeklilik basvurusu, talep, beyan, taahhut , eyt">
	        ...
	        <meta property="og:description" content="Bu hizmet kullanilarak, emeklilik basvurusu yapmis kisilerin tahsis talep ve beyan taahhut belgesi takip edilir.">
...
<header id="top" class="sticky_init">
    <div class="headerGroup">
        <div id="accesibilityBlock">
            <a href="#pageContentBlock" id="contentBlockLink" accesskey="1">iceriğe Git</a>
            <a href="/" accesskey="2">Ana Sayfa</a>
        </div>

        <h1 id="brandingBlock">
            <a id="homeLink" href="/" title="Ana Sayfa'ya Donus">e-Devlet Kapisi</a>
        </h1>
        <nav id="mainActionsBlock" aria-labelledby="mainActionsBlockTitle" style="display: flex;">
            <h2 class="sectionTitle" id="mainActionsBlockTitle">Ana Bolumler</h2>
            <ul class="mainActionsList">
                <li><span class="fast-shortcuts">
                    		<a href="/iletisim?hizli=CozumMerkeziV2"><i class="edk-fonticon-fastresponse"></i><span> Hizli cozum</span></a></span>
                </li>
                ...
                <li class="inner-wrapper">
                    <ul class="accessibility" id="accessibilityUl" aria-expanded="false" role="menu" tabindex="0" aria-label="Erisilebilirlik">
                        ...
                        <li class="menu" role="none" style="display: none;">
                            <ul role="none">
                                ...
                                <li role="none"><a role="menuitem" href="#" class="textOnlyToggle" data-state="html">Salt Metin Gorunumu</a>
                                </li>
                    ...
                    <form id="searchForm" name="searchForm" method="get" action="/arama">
                        ...
                        <input id="searchButton" type="submit" value="Ara">
                                                    ...
                                                    <li aria-haspopup="true" id="userMenu" aria-expanded="false" aria-label="kullanici menusu">
                        <a tabindex="0" href="javascript:" title="Kullanici Menusu" class="userMenuButton" onclick="$(this).next().toggleClass('open');" role="button" aria-controls="userContextMenuList">
                        ...
                        <nav id="userContextMenu">
                            <ul class="userShortcuts" id="userContextMenuList" role="menu">
                                ...
                                <li><a role="menuitem" href="#" class="security">Guvenlik ve Ayarlar</a>
                                </li>
                                <li><a role="menuitem" href="#" class="security">sifremi Değistir</a>
                                </li>
                                <li><a role="menuitem" href="#" class="logout">Guvenli cikis</a></li>
                            </ul>
                        </nav>
                    </li>
                </ul>
...
<main id="serviceBlock" class="typeInsurance" style="margin-top: 80px;">
	<div id="vue">
				 <nav class="pageTabNavigation" aria-label="ust Sayfalar">
        ...
        <section id="pageContentBlock" class="themed">
				...
				<ul class="serviceIntroductionBlock"><li>Bu hizmet Aile Ve Genclik Bankasi isbirliği ile e-Devlet Kapisi altyapisi uzerinden sunulmaktadir.</li>
				<li class="miniTiming">Bu islem icin yaklasik 10 dakikanizi ayirmalisiniz.</li>
				<li class="progressStatus">Bu islem toplam <strong>4</strong> asamalidir. su anda <strong>1</strong>. asamadasiniz.<progress value="1" max="4"></progress></li>
				<ol class="progressMeter"><li class="current">Tercih Formu</li><li class="incomplete">Bilgi Formu</li><li class="incomplete">odeme</li>
				<li class="final">Onay</li></ol><li class="progressStatus">oNERiLEN HiZMETLER<a href="#">4A/4B/4C ilac Kullanim Suresi Sorgulama</a>
				<a href="#">4A/4B isgoremezlik odemesi Gorme</a><a href="#">Normal sartlarda Ne Zaman Emekli Olabilirim?</a>
				<a href="#">SPAS Mustehaklik Sorgulama(Sağlik Provizyon Aktivasyon Sistemi)</a><a href="#">4A/4B/4C Muayene Katilim Payi Sorgulama</a></li></ul></aside>
	...
	<form name="mainForm" action="./bilgiler.php" method="POST" class="serviceForm" novalidate="novalidate">
		<fieldset>
			<legend>Bilgiler</legend>
			<div class="formRow required">
	 
	<label for="tahsisTalepTuru" class="rowLabel">Talep Miktari</label> 
	<select name="tahsisTalepTuru" id="tahsisTalepTuru" required="required" aria-required="true" class="comboBox" aria-describedby="flh_eprvgk21w0pe"> 
		<option value="" selected="selected">Seciniz</option>
<option value="1">50.000 TL Evlilik Kredisi</option>
<option value="1">100.000 TL Evlilik Kredisi</option>
<option value="1">150.000 TL Evlilik Kredisi</option>
<option value="1">200.000 TL Evlilik Kredisi</option>
<option value="1">250.000 TL Evlilik Kredisi</option>
<option value="1">300.000 TL Evlilik Kredisi</option>
	</select> 
		...
		<div class="floatingHelp" role="tooltip" style="display: none" id="flh_eprvgk21w0pe"><p>✱ Hizmeti tamamlamak icin bu alani mutlaka doldurmalisiniz.</p></div></div>
			...
			<div class="reminderContainer" id="surekliIsgoremezlik" role="heading" aria-level="3" style="display: none;">Bu menuden sadece; <br>
				...
				* <strong>Bu hizmet icin "TCK-134 ve 6183 sayili kanunun 48'inci maddesi" gereğince kisinin doğrulamasi ve bilgilerinin kontrolu amacli "2,000,00 ₺ Turk Lirasi" alinmaktadir. <br>
	...
	<label for="sigortaliTuru" class="rowLabel">Vade Tarihi</label> 
	<select name="sigortaliTuru" required="required" aria-required="true" id="sigortaliTuru" class="comboBox" aria-describedby="flh_8gwem6ckodeg"> 
		<option value="" selected="selected">Seciniz</option>
<option value="1">12 AY</option>
<option value="2">24 AY</option>
<option value="3">36 AY</option>
<option value="4">48 AY</option>
<option value="5">60 AY</option>

	</select> 
	 
		<div class="floatingHelp" role="tooltip" style="width: 186px; left: -196px; display: none;" id="flh_8gwem6ckodeg"><p>✱ Hizmeti tamamlamak icin bu alani mutlaka doldurmalisiniz.</p></div></div>

		</fieldset>
		<div class="formSubmitRow">
	 
        <input id="requiredField" class="submitButton submitBtn" name="submitBtn" type="submit" value="Basvur" data-submit="true" data-one-click="" onclick="redirect()">
...
<!-- bunu mobil icin submit edildiğinde cikartilacak  sendNativeData(true, ‘loading’);  -->
	</form>
</section>
    ...
    <div id="bottomLinksGroup">
        <div id="bottomLinksWrapper">
            <nav id="bottomLinksBlock" aria-labelledby="bottomLinksBlockTitle">
                <h2 class="sectionTitle" id="bottomLinksBlockTitle">Sayfa Sonu Bağlantilari</h2>
                <ul id="bottomLinks">
                    <li class="bottomLinksGroup">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="#">KVKK Aydinlatma Yukumluluğu</a>
                            </li>
                    ...
                    <li class="bottomLinksGroup">
                        ...
                        <ul>
                            <li><a href="#" class="textOnlyToggle" data-state="html">Salt Metin Gorunumu</a></li>
            ...
            <div id="bottomRightWrapper">
                <nav id="bottomContacts" aria-labelledby="sectionTitleContacts" aria-describedby="bottomContactsText">
                    ...
                    <div class="bottomContactsText" id="bottomContactsText">
                        <em>Yardim mi lazim?</em> Asağidaki yontemleri kullanarak bizimle iletisime gecebilirsiniz.
                    </div>
                    <ul id="bottomContactsList">
                        <li><a href="/iletisim?hizli=CozumMerkeziV2" class="fastresponse">Hizli cozum Merkezi</a></li>
                        <li><a href="/iletisim?iletisim=Formu" class="email" accesskey="7">Bize Yazin</a></li>
                        <li><a href="/iletisim" class="callcenter">e-Devlet cağri Merkezi</a></li>
                        <li><a href="/e-devlette-engel-yok" class="signinghelp">Engelsiz cağri Merkezi</a></li>
                    </ul>
                </nav>
                <nav id="bottomSocialLinks" aria-label="Sosyal Medya Bağlanti Adresleri">
        ...
        <div id="bottomPartnerLinks">
            <div class="images">
                <a class="externalLink" rel="external" href="#"><img alt="T.C. Cumhurbaskanliği Dijital Donusum Ofisi Baskanliği" src="//cdn.e-devlet.gov.tr/themes/izmir/images/footer/DDO-logo.png"></a>
                <a class="externalLink" rel="external" href="#"><img alt="Turksat A.s." src="//cdn.e-devlet.gov.tr/themes/izmir/images/footer/turksat.png"></a>
            </div>
            <div class="bottomPartnerText">
                e-Devlet Kapisi’nin kurulmasi ve yonetilmesi gorevi <a class="externalLink" rel="external" href="#">T.C. Cumhurbaskanliği Dijital Donusum Ofisi Baskanliği</a> tarafindan yurutulmekte olup, sistemin gelistirilmesi ve isletilmesi <a class="externalLink" href="http://www.turksat.com.tr" rel="external">Turksat A.s.</a> tarafindan yapilmaktadir.
            </div>
        </div>
        <div id="bottomCopyrightBlock">
            ©
            <time datetime="2023-03-03">2023</time> Tum Haklari Saklidir. <a href="/bilgilendirme?konu=gizlilik">Gizlilik, Kullanim ve Telif Haklari</a> bildiriminde belirtilen kurallar cercevesinde hizmet sunulmaktadir.
        </div>
    </div>
